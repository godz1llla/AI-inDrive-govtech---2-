...
<p align="center">
  ...
  <br>
  <em>Главный экран системы: реестр заявок с AI-скоринг и вердиктами (Темная тема)</em>
</p>

### 7. 🏛️ Operational Registry (Regional View)
Для региональных комиссий реализован облегченный **Operational Registry**, позволяющий фокусироваться на целевых показателях эффективности и суммах выплат. 

**Ключевые особенности:**
- **Региональный фильтр**: Автоматическая привязка к области при авторизации члена комиссии.
- **Индикатор AI Score**: Визуальная шкала (0-100) для быстрой приоритизации заявок.
- **Двуязычный интерфейс**: Мгновенное переключение RU/KZ для удобства работы в регионах.

<p align="center">
  <img src="docs/govtech_dss_registry_white.png" width="800" alt="Operational Registry View">
  <br>
  <em>Операционный реестр: вид для региональных рабочих групп (Светлая тема)</em>
</p>
